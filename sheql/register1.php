...
<form method="post" enctype="multipart/form-data"  onsubmit="return validateForm()"  class="form-horizontal form-signin" name="myform" role="form">
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input name="email" type="email" required class="form-control" id="inputEmail3" value="<? if(isset($_POST['email'])) echo  $_POST['email']; ?>" placeholder="Email">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-4 control-label"><span class="red">*</span> Password</label>
    <div class="col-sm-8">
      <input name="password" type="password" class="form-control" id="inputPassword3" value="<? if(isset($_POST['password'])) echo  $_POST['password']; ?>" placeholder="Password" required>
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-4 control-label"><span class="red">*</span> Confirm Password</label>
    <div class="col-sm-8">
      <input name="confirm" type="password" class="form-control" id="inputPassword3" value="<? if(isset($_POST['confirm'])) echo  $_POST['confirm']; ?>" placeholder="Password" required>
    </div>
  </div>
