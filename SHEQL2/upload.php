...
<ol class="breadcrumb">
 ...
 <?php if(isset($_SESSION['new_user_id']) ) {?> <li><a href="register.php">Register</a></li>
  <li class="active">Step 2</li><?php }else{ ?>
  <li><a href="upload.php">Upload</a></li><?php } ?>
</ol>
<?php
...
/*				$query = "select * from sn_pictures	 where user_id='".$user_id."' order by `pic_id` desc";
				...
				if(isset($_FILES['uploaded_files']))
				{
						...
						else
        			{
						...
						echo '<div class="alert alert-success">The bill was sucesfully uploaded.</div>';
